...
{
    public partial class zorHarita : Form
    {
        ...
        private void zorHarita_Load(object sender, EventArgs e)
        {
            ...
            mayinTarlasi = new mayinTarlasi(new Size(900,900),90); // Büyüklük ve mayın sayısı belirledik
        ...
        public void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                mayinlariGoster();
                OyunBitti("Kaybettin zor");
            }
            else if (enabledButtonSayisi < 810)
            {
                    ...
                    for (int i = 0; i < mayinlarimiz.Count; i++)
                    {
                        ...
                        if (item != null)
                        {
                            if (item.bakildi == false && item.mayinKontrol == false)
                            {
                                ...
                                item.bakildi = true;
                                if (enabledButtonSayisi >= 810)
                                {

                                    mayinlariGoster();
                                    OyunBitti("Kazandın zor");
                                }
                            }
                        }
                    }
        ...
        {
            if (value == "Kazandın zor")
            {
                gameOver gameOver = new gameOver();
                gameOver.value = "Kazandın zor";
                gameOver.ShowDialog();
            }
            else if (value == "Kaybettin zor")
            {
                gameOver gameOver = new gameOver();
                gameOver.value = "Kaybettin zor";
                gameOver.ShowDialog();
            }
        ...
        private void zorHarita_FormClosing(object sender, FormClosingEventArgs e)
        {
