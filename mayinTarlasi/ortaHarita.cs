...
{
    public partial class ortaHarita : Form
    {
        ...
        private void ortaHarita_Load(object sender, EventArgs e)
        {
            ...
            mayinTarlasi = new mayinTarlasi(new Size(900, 900), 40); // Büyüklük ve mayın sayısı belirledik
        ...
        public void btn_Click(object sender, EventArgs e)
        {
            ...
            {
                mayinlariGoster();
                OyunBitti("Kaybettin orta");
            }
            else if (enabledButtonSayisi < 860)
            {
                    ...
                    for (int i = 0; i < mayinlarimiz.Count; i++)
                    {
                        ...
                        if (item != null)
                        {
                            if (item.bakildi == false && item.mayinKontrol == false)
                            {
                                ...
                                item.bakildi = true;
                                if (enabledButtonSayisi >= 860)
                                {

                                    mayinlariGoster();
                                    OyunBitti("Kazandın orta");
                                }
                            }
                        }
                    }
        ...
        {
            if (value == "Kazandın orta")
            {
                gameOver gameOver = new gameOver();
                gameOver.value = "Kazandın orta";
                gameOver.ShowDialog();
            }
            else if (value == "Kaybettin orta")
            {
                gameOver gameOver = new gameOver();
                gameOver.value = "Kaybettin orta";
                gameOver.ShowDialog();
            }
        ...
        private void ortaHarita_FormClosing(object sender, FormClosingEventArgs e)
        {
